    ...
    <div className="relative flex flex-col items-center gap-4 w-full">
      ...
      <div className="relative w-72 h-72 mx-auto">
        ...
        {scannerReady && (
          <>
            {[
              ...
              <div key={i} className={`absolute w-8 h-8 ${cls}`} style={{ borderColor: '#00CFFF' }} />
            ))}
            {/* Scan line animation */}
            <motion.div
        ...
        {!scannerReady && !cameraError && (
          <div className="absolute inset-0 flex items-center justify-center rounded-2xl" style={{ background: 'rgba(15,19,34,0.8)' }}>
            <Loader2 className="w-8 h-8 animate-spin" style={{ color: '#00CFFF' }} />
          </div>
        )}
      </div>
  ...
  if (!currentUser) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-5 px-6 text-center" style={{ background: '#050814' }}>
        <QrCode className="w-12 h-12" style={{ color: '#00CFFF' }} />
        <div>
    ...
    <div className="min-h-screen flex flex-col" style={{ background: '#050814' }}>
      ...
      <div className="flex items-center justify-between px-5 py-4 shrink-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div className="flex items-center gap-2">
          <QrCode className="w-4 h-4" style={{ color: '#00CFFF' }} />
            ...
            >
              {phase === 'checking' ? (
                <div className="flex flex-col items-center gap-4">
                  <Loader2 className="w-16 h-16 animate-spin" style={{ color: '#00CFFF' }} />
